...
export function Personagem() {
    ...
    return (
        <div className="grid md:grid-cols-4 lg:grid-cols-3 gap-[30px] mt-[24px]">
            {personagens.map(personagem => (
                <div className="w-[600px] h-[220px] drop-shadow-2xl duration-[100ms] hover:bg-blue-200 border-[2px] border-blue-200" key={personagem.id}>
                    <div className="flex gap-[20px]">
                        ...
                        <div className="mt-[30px] font-JOCKEYONE text-black text-[24px]">
                            <p title={personagem.name} className="hover:text-pink">
                                {personagem.name.length > 16 ? personagem.name.substring(0, 20) + "..." : personagem.name}
                            </p>
                            ...
                            <div className="flex gap-x-[12px] mb-[30px]">
                                <div className="flex items-center gap-[4px] text-[18px] hover:text-pink">
                                    ...
                                    {personagem.status === "unknown" && <Ghost size={32} />}
                                </div>
                            ...
                            <p className="text-[18px] text-gray-500">Ultima vez visto em: </p>
